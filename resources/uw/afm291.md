...
why is it helpful to have periodic reporting (as opposed to simply waiting until dissolution of the company)? because corporations have indefinite lives (you may have to wait centuries!) and it's more cost-effective for corporations to report all information at pre-specified intervals, rather than respond to information requests from each individual investor or lender.
