...
- 5 types of transactions that can affect the above 3 components of equity:
  1. profit or loss (recorded on IS)
  1. OCI (other comprehensive income)
  1. paying out dividends
  1. capital transactions (aka transactions with owners, ie. issuing shares or repurchasing shares)
  1. effect of changes in accounting policy or correction of errors
