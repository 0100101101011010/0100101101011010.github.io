...
deductions only applicable to business income:

- reserves
- expenses of representation
- expense of site investigation
- utilities services connection
- convention expenses
- short-year proration for CCA

deductions only applicable to property income:

- restriction on CCA for rental properties
- attribution rules
- foreign taxes on property income in excess of 15% are deductible
...
note: Sched 1 could either only reconcile business income, or could also include property income and capital gains. read question to see what it asks.
...
note: the grossed-up amount of the dividend (dividend received * (1 + gross-up rate)) is the amount to be included in Div B property income.
...
1. deduct the amount of tax withheld by foreign tax authority from the tax owing (this is your FTC)
1. in summary: canadian tax = (dividend received + foreign tax withheld) × individual's tax rate – foreign tax withheld (aka FTC)
...
- brokerage fees from purchase or sale of securities (these are capitalized and will affect the capital gain or loss on the eventual disposition of the property)
  - in fact, all fees incurred for acquiring or selling capital property must be capitalized

### DEDUCTIBLE EXPENSES FOR INDIVIDUALS

- interest (subject to [specific rules](#interest))
- dividends
- mgmt fees
- safe custody fees
  - note: safety deposit box fees are prohibited
- accounting fees
- investment counsel fees (the advisor being paid must have their principal business in investment counselling and fund management and the advice cannot relate to RRSP-earned income)
- legal and accounting fees (if they are incurred to produce business or property income)
  - including fees paid for assistance in objecting to CRA, tax court, or other govt office
  - fees for preparation of tax return is deductible *if there is a source of property income*
...
- deduct any selling expenses from the total proceeds
- if the property includes a land portion + building portion, must split both the original cost and the proceeds accordingly (eg. 25% of the cost, and 25% of the proceeds, relate to land; 75% relate to building)
- taxable capital gain (calculate separately for land/building portions) = 50% * (proceeds from the sale of a portion – original cost of that portion)
- for CCA: UCC – LOCP = income recapture if negative, terminal loss if positive (assuming the building is > $50k and thus in its own separate class)
  - note: land is not depreciable, so UCC of a rental property is for the building *only*, not including the land portion
  - remember CCA cannot create or increase a net rental loss
...
must meet three criteria to be considered interest:

- is calculated on a day-to-day accrual basis
- is calculated with a principal sum as the cost basis
- is compensation for the use of the principal sum

interest is deductible if:

- it's paid or payable in the CY
- arises from a legal obligation
- it's payable on money borrowed for the purpose of earning business or property income
  - note: do not actually have to earn CY income as long as it was *expected* to earn income
  - eg. mortgage interest is deductible if the mortgage is taken out to invest in securities because the expectation is to produce income; it's *not* deductible if the mortgage is to buy personal property (like a house) because the intent there is not to produce income
  - therefore it's smart to take out loans for income-producing purposes, while using personal savings to buy personal assets
- reasonable

specifically non-deductible:

- interest paid as a result of late tax payments
- interest on funds borrowed to buy vacant land
- interest on funds borrowed to contribute to RRSPs
- interest that is part of "soft costs" (these should be capitalized)
  - taxpayer can also elect to turn deductible interest into non-deductible expense and include it in capital property, for CCA deductions. why would you do this? if the deduction of these costs would create a loss that cannot be entirely offset through loss carryover
    - most advantageous for fast write-off assets like class 12
- some types of interest paid to non-residents

interest on money borrowed to...

- buy shares in a company that *never pays dividends* (theoretical; a company like that doesn't exist irl) = deductible because there could be *liquidating dividends* upon company's dissolution
- buy preferred shares = deductible
  - preferred shares get dividends first (a fixed amount usually), but don't have voting rights
- buy lottery tickets = not deductible even if you do end up winning, but if money from the winnings were used to produce property income (like buying shares or a GIC), then the interest (assuming the loan has not been paid back) does become deductible
- buy shares that paid dividend, and the shares are later sold to pay mortgage on principal residence = deductible while the shares were held; not deductible after shares were sold because the proceeds were spent on a personal-use property

- start with net income for financial statement purposes = 900,000
- deduct accting gain on land = (50,000)
- deduct accting gain on sale of = (95,000)
- add back loss on sale of = 20,000
- add back loss on sale of trademark = 10,000
- add recapture on trademark = 900
- add taxable capital gain on land
- add taxable capital gain on buiding
- add back dep/amort = 80,000
- deduct allowable capital loss on securities = 10,000
- deduct allowable capital loss on note receivable = 2,500
- add back CRA
- add back charitable donation = 10,000
-
accounting mistake: did not recognize the capital loss on the note receivable

omitted (aka tax and accting have same treatment):

- $14,000 (assuming the employee dinner-dance was for all employees and was within the 6 events per year)
- note: if accting had correctly included the capital loss on the note receivables, you would have to *add back* 2,500 instead (because accting would have recognize the full loss, ie. 5,000, but only half of that is allowable by tax)
