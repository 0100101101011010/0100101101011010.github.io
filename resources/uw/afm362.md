...
### Division B Subdivision B: Income or Loss from a Business or Property
...
1. deduct dispositions during the year:
  - use lesser of cost or proceeds (LOCP)
1. = adjusted UCC
...
![third party misrepresentation penalty](/resources/uw/images/ccadisposition.jpg){:width="100%"}
...
- any used (or previously-acquired) property, unless both conditions are met:
  1. property was not previously owned by the taxpayer or a non-arm's length person
  1. property was not transferred via a tax-deferred rollover method
