...
## L5 & 6: Business Income

difference between calculating employment income and business income:

- for individuals, start with 0 and add inclusions to income. a bunch of different sources of income, but only a few exceptions (ie. only employment-related expenses)
- for businesses, . only one source of income, but a lot of different exceptions

business income vs property income vs capital gains:
...
- property income = *passive* generation of earnings. very little activity required.
  - eg. rental income, dividend income, interest income
...
### Division B Subdivision B: Business Income Inclusions and Deductions

- sec. 9 = income
- sec. 12 = income inclusions
- sec. 18 = deductions: general limitations
- sec. 20 = deductions: specific expenses allowed
...
must adjust the figures to arrive at the income for tax purposes, called "Schedule 1 Reconciliation"
...
- business income is treated on a more accrual basis than employment income, so A/R is included in income
- unearned aka deferred revenue is also considered that year's income
- barter transactions
...
- criteria for something to be deductible
  - deductible under GAAP (financial accounting rules)
  ...
  - was incurred to earn taxable income
  ...
  - not a personal expense or expenditure
